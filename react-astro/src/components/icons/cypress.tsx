...
const CypressIcon = () => (
	<SVG xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 100 100">
		<g clipPath={`url(#${idA})`}>
			...
			<path
				fill="#fff"
				d="M38.16 39.685c4.046 0 7.342 2.157 9.036 5.921l.134.295 6.795-2.308-.145-.348c-2.631-6.408-8.692-10.391-15.82-10.391-5.01 0-9.083 1.606-12.448 4.904-3.345 3.276-5.038 7.398-5.038 12.254 0 4.813 1.693 8.914 5.038 12.19 3.365 3.298 7.438 4.904 12.449 4.904 7.127 0 13.188-3.983 15.82-10.386l.144-.348-6.806-2.313-.129.306c-1.516 3.699-4.892 5.91-9.03 5.91-2.818 0-5.198-.985-7.084-2.923-1.908-1.965-2.873-4.433-2.873-7.335 0-2.923.944-5.343 2.873-7.398 1.88-1.949 4.266-2.934 7.084-2.934"
			/>
			<path
				fill="#fff"
		...
		<defs>
			...
			>
				<stop offset=".094" stopColor="#58d09e" />
